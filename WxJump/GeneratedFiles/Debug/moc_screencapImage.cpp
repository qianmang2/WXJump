...
QT_MOC_LITERAL(3, 32, 15), // "showImageFinish"
QT_MOC_LITERAL(4, 48, 10), // "jumpFinish"
QT_MOC_LITERAL(5, 59, 9) // "showImage"

    },
    "ScreencapImage\0screencapfinish\0\0"
    "showImageFinish\0jumpFinish\0showImage"
};
...
void ScreencapImage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showImageFinish(); break;
        case 2: _t->jumpFinish(); break;
        ...
        {
            typedef void (ScreencapImage::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScreencapImage::showImageFinish)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ScreencapImage::showImageFinish()
{
